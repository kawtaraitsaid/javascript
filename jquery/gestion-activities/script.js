...
// aide a trouver l'activiter modifier
    let activite_modifier = activites_stagiaires.find(function(item){
        return item.id == selected_activite;

        if (activite_a_modifier) {
            activite_modifier.nom = nom;
            activite_modifier.prenom = prenom;
            activite_modifier.activite = activite;
            activite_modifier.nb_jours = nb_jours;
            activite_modifier.date_activite = date_activite;
            activite_modifier.valide = valide;
        } 
        afficher_activites();
